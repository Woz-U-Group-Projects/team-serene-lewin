...
public class DessertController {
	...
	@GetMapping("/dessert/{itemid}")
    public ResponseEntity<Dessert> getDessert(@PathVariable(value="itemId") String itemId) {
        
		Dessert foundDessert = dessertRepository.findById(itemId).orElse(null);
